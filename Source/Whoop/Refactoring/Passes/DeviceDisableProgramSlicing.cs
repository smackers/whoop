...
{
  internal class DeviceDisableProgramSlicing : DomainSpecificProgramSlicing, IDeviceDisableProgramSlicing
  {
    #region public API
    ...
    public void Run()
    {
      ...
      {
        base.Timer.Stop();
        Console.WriteLine(" |  |------ [DeviceDisableProgramSlicing] {0}", base.Timer.Result());
      }
    }
