...
//      this.CreatePairs();
//
//      foreach (var region in this.AC.PairCheckingRegions)
...
//      {
//        Implementation impl = this.AC.GetImplementation(ep.Item1.Name);
//        List<Implementation> implList = new List<Implementation>();
//
//        implList.Add(this.AC.GetImplementation(ep.Item2.Name));
//
...
//
//        foreach (var v in ep.Item2)
//        {
//          consList.Add(this.AC.GetConstant(v));
//        }
//
